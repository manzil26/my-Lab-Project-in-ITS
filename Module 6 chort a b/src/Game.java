...
public class Game {
    ...
    private int moves = 0;
    private Human hooman;
    private Monster monstah;
    ...
    public void startGame(){
        ...
        name = read.nextLine();
        hooman = new Human(name); // memasukkan nama human ke metode human
        System.out.println("Input Monster's Name: ");
        name = read.nextLine();
        ...
        //Start a round 3 times // ini seperti level
        for(int i= 1; i<4; i++){
            System.out.println();
    ...
    public void turnStart(){
        ...
        if(choice == 1 ){
            if(moves % 2 == 0 ){
                // ini untuk memanggil metode
                monstah.attacked(hooman.attack()); // monster diserang oleh manusia
            }
            else hooman.attacked(hooman.attack());
            moves++;
        } else if (choice == 2){
    ...
    public boolean aliveChecker(){
        ...
        if(monstah.healthChecker() || hooman.healthChecker()) return true;
        else return false;
    }
    ...
    public void roundRecord(int round){
        ...
        try{
            //Declare a FileWriter type variable to write on a file and assign a file path (Set append to true so we can keep writing on the same file)
            ...
            String winner;
            if(hooman.healthChecker()) winner = "Monster";
            else winner = "Human";
    ...
    private static void displayMenu(){
        ...
        try {
            ...
            FileReader fileReader = new FileReader("turnMenu.txt");
